    ...
    )
{
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEBYTES, TRUE, L"专用字节", 70, PH_ALIGN_RIGHT, 3, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKPRIVATEBYTES, FALSE, L"峰值专用字节", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEWS, FALSE, L"专用工作集", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_GDIHANDLES, FALSE, L"GDI 句柄", 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_USERHANDLES, FALSE, L"USER 句柄", 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumn(hwnd, PHPRTLC_VERIFIEDSIGNER, FALSE, L"验证签名者", 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_PRIVATEBYTESHISTORY, FALSE, L"专用字节历史记录", 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PAGEFAULTSDELTA, FALSE, L"缺页错误增量", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumn(hwnd, PHPRTLC_OSCONTEXT, FALSE, L"OS 上下文", 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEBYTESDELTA, FALSE, L"专用字节增量", 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    ...
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_TIMELINE, FALSE, L"时间轴", 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    ...
    PhAddTreeNewColumn(hwnd, PHPRTLC_GRANTEDACCESS, FALSE, L"授予访问权限 (符号)", 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumn(hwnd, PHPRTLC_START_KEY, FALSE, L"启动键值", 120, PH_ALIGN_LEFT, ULONG_MAX, 0);
