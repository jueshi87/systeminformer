    ...
    )
{
    ...
    if (!ReloadOnly)
    {
        ...
        PhAddListViewItem(listViewHandle, PHP_OPTIONS_INDEX_ENABLE_GRAPH_SCALING, L"启用固定图表缩放 (实验性)", NULL);
        ...
        PhAddListViewItem(listViewHandle, PHP_OPTIONS_INDEX_ENABLE_STREAM_MODE, L"启用主播模式 (禁用窗口捕获) (实验性)", NULL);
        ...
        PhAddListViewItem(listViewHandle, PHP_OPTIONS_INDEX_ICON_TOGGLE_VISIBILITY, L"点击图标切换可见性", NULL);
