    ...
    )
{
    ...
    PhAddTreeNewColumn(hwnd, PHHNTLC_GRANTEDACCESSSYMBOLIC, TRUE, L"授予访问权限 (符号)", 140, PH_ALIGN_LEFT, 2, 0);
    ...
    PhAddTreeNewColumn(hwnd, PHHNTLC_GRANTEDACCESS, FALSE, L"授予访问权限", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumn(hwnd, PHHNTLC_POINTERCOUNT, FALSE, L"引用数", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
